...
/* Size of bub explosions */
#define BUB_EXPL_SIZE 52
#define BUB_EXPL_DIV 30
...
#define SCORE_POS BOARD_RIGHT + BUB_SIZE / 2 + 5
#define GAME_OVER_POS SCREEN_WIDTH / 2 - 148
#define YOU_WON_POS SCREEN_WIDTH / 2 - 140
#define PAUSE_POS SCREEN_WIDTH / 2 - 130
#define ROUND_POS SCREEN_WIDTH / 2 - 105
